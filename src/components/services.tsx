...
>
  ...
  <div className="absolute inset-0 bg-gray-50  dark:bg-gray-700 rounded-2xl z-0" />
  </div>
  ...
  <div className="relative z-10 p-8 sm:p-10 rounded-2xl shadow-xl h-full flex flex-col backdrop-blur-md">
    ...
    <div className="mt-auto flex justify-center">
      <Link
        href="#contact"
        className="group flex items-center gap-1 bg-white/20 hover:bg-white/30 text-neutral-600 dark:text-white px-4 py-2 text-sm rounded-full transition-all duration-300 shadow hover:shadow-md"
      >
        <span>Hire Me</span>
  ...
  <style jsx global>{`
    ...
    .swiper-pagination-bullet {
      background: dark:white black !important;
      opacity: 0.6;
    }
